...
//this is the only part you should need to change when setting up a new experiment. Also, read the readme.txt to figure out which textfiles you need to put in $path location.
    ...
    $type =         'paintwords';       // $type has to be one of the $allowedTypes (remember quotes)
    ...
    $path="/var/www/emotion.becs.aalto.fi/sensations_embody_FI/";
	$wwwlocation = 'http://emotion.nbe.aalto.fi/sensations_embody_FI/';
