...
//this is the only part you should need to change when setting up a new experiment. Also, read the readme.txt to figure out which textfiles you need to put in $path location.
    ...
    $language =     'UK';                 // two-letter language code, will be added to end of file names to get texts in correct language. If study is only in one language, you can leave this to ''
    $countryID = 185; // number for the preselected language and nationality
    ...
    $path="/var/www/emotion.becs.aalto.fi/sensations/";
	$wwwlocation = 'http://emotion.nbe.aalto.fi/sensations/';
