...
if(supportsTouch) {
	alert("This experiment is not designed for touch screen devices. We are sorry for the inconvenience.");
window.location.href="http://emotion.nbe.aalto.fi/site/";
}
...
<form id="intro" method="GET" action="session_sim.php">
<div >
