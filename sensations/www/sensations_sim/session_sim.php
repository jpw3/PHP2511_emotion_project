...
// WE HAVE THE SUBJECT, LET'S START THE SESSION
	...
	$outdatapath='./subjects/'.$userID.'/outdata.csv';
    ...
    //$outtext.="<div id=\"headeralways\">".$pagetexts['sub_ID']." <span style=\"color:#fc0;font-weight:bold;\">".$userID."</span><span style=\"margin-left:50px;\">".$pagetexts['done_perc']." ".$perc."%</span></div>";
    $outtext.="<div id=\"headeralways\">".$pagetexts['sub_ID']." <span style=\"color:#fc0;font-weight:bold;\">".$userID."</span></div>";
 ...
 //   $outtext.="<div id='progress-bar' class='all-rounded' style=\"float:right\"> <div id='progress-bar-percentage' class='all-rounded' style='font-size:14px;font-weight:bold;margin-left:100px;position:absolute'> <span>".$pagetexts['done_perc'].$perc."%<br></span>";
    ...
    if($amount == 1){
        ...
        $outtext.="<br><h1>".$pagetexts['thank-you']."</h1><br><br><br><div style=\"width:400px;text-align:center;margin-left:auto;margin-right:auto\"><a class=\"bottone\" href=\"http://emotion.nbe.aalto.fi/site/index.php/participate/\">".$pagetexts['participate']."</a></div>";
    ...
    if($amount < 1)
    {
		...
		$outtext.=insertVarValues($pagetexts['code'],$helpful);
        ...
        if ($type=="form"):
            $goto="sim.php?perc=$perc&userID=$userID&presentation=$presentation";
        else:
